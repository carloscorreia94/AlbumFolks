...
class CoreNetwork {
    ...
    struct API_URLS {
        static let ArtistDetail = API_URL_FORMAT_AND_METHOD + "artist.getinfo"
    }
    
    static let API_URL = "https://ws.audioscrobbler.com/2.0/"
    static let API_URL_FORMAT = API_URL + "?\(COMMON_KEYS.FORMAT_KEY_AND_VALUE)"
    static let API_URL_FORMAT_AND_METHOD = API_URL_FORMAT + "\(COMMON_KEYS.FORMAT_KEY_AND_VALUE) &\(COMMON_KEYS.METHOD_KEY)="
